...
function LucaLandingHeroSection() {
  return (
    <div className="relative w-full bg-violet-100 overflow-hidden">
    ...
    <div className="px-7 max-w-7xl mx-auto flex flex-col gap-y-10 lg:flex-row items-center gap-x-10 justify-center py-10 lg:py-12 dark:bg-gray-800">
      <div className="w-full flex flex-col gap-y-5">
        ...
        Luca: Your AI Accountant for Effortless Bookkeeping & Financial Reports
        </h1>
        ...
        Luca is an AI-powered accounting assistant designed to streamline bookkeeping, financial record-keeping, and reporting.</p>
      ...
      <Image className="rounded-3xl w-full" src={luca} alt="luca" width={750} height={750} />
    </div>
