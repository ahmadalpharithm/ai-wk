...
const features = [
  { number: "01", title: "Automated Bookkeeping", description: "Converts text inputs into structured accounting records." },
  { number: "02", title: "Real-Time Financial Reporting", description: "Instantly updates records and generates reports." },
  { number: "03", title: "Flexible Input", description: "Manual entry options for users who prefer hands-on control." },
  { number: "04", title: "Document & Receipt Management", description: "Attach invoices, receipts, and supporting files." },
  { number: "05", title: "Always Available", description: "24/7 AI support, ready whenever you need it." },
];
