...
const sections: { title: string; description: string; image: StaticImageData }[] = [
  {
    ...
    description: "seeking quick, unbiased investment assessments",
    image: inverstors,
  },
  {
    title: "Hedge Funds & Asset Managers",
    description: "conducting in-depth research.",
    image: rename,
  },
  {
    title: "Investment Firms",
    description: "looking to enhance or replace internal research teams.",
    image: firms,
  },
  {
    title: "Analysts & Traders",
    description: "who need a comprehensive review of shortlisted stocks.",
    image: traders,
  },
];


function OrionSmartAccounting() {
  const [activeIndex, setActiveIndex] = useState<number | null>(null);
  const [selectedImage, setSelectedImage] = useState<StaticImageData>(inverstors); // Default image
  ...
  return (
    <div className="w-full h-[643px] relative bg-red-100 overflow-hidden">
      {/* Side Image */}
      <Image
        src={selectedImage}
...
export default OrionSmartAccounting;
