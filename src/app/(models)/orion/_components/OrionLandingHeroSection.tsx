...
function OrionLandingHeroSection() {
  return (
    ...
    <div className="px-7 max-w-7xl mx-auto flex flex-col gap-y-10 lg:flex-row items-center gap-x-10 justify-center py-10 lg:py-12 dark:bg-gray-800">
      <div className="w-full flex flex-col gap-y-5">
        ...
        Orion: Professional-Grade Equity Analyst
        </h1>
        ...
        Orion is a professional-grade AI equity analyst that delivers deep fundamental, technical, and sentiment analysis using financial reports, market data, analyst research, earnings call transcripts, and key news catalysts.</p>
      ...
      <Image className="rounded-3xl w-full" src={orion} alt="luca" width={750} height={750} />
    </div>
...
export default OrionLandingHeroSection
