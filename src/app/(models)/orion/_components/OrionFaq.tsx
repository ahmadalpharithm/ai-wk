...
const faqs = [
  {
    question: "What are the pricing plans for Orion",
    answer: [
      "For orders under $100, each report costs $10.",
      "For orders over $100, each report costs $8.",
      "For orders over $1,000, each report costs $6.",
      "For orders over $10,000, each report costs $4."
    ],
    isBulletList: true, // 🔹 This question will have bullet points
  },
  {
    question: "Can Orion be Customized?",
    answer: [
      "Need custom features? Contact us to tailor Orion to your specific business needs."
    ],
