  ...
  return (
    ...
    <div className="self-stretch inline-flex justify-between items-end">
        <div className="w-96 inline-flex flex-col justify-start items-start gap-3">
            <h4 className="self-stretch justify-start text-white text-xl font-medium">Sample Orion Output</h4>
            <p className="self-stretch justify-start text-white text-base font-normal leading-7">Download a copy of a report generated by Orion.</p>
        </div>
    ...
    <div className="self-stretch inline-flex justify-between items-center">
        <h1 className="w-full max-w-96 justify-start text-white text-5xl font-bold leading-[55px]">Get professional grade investment insights in minutes!</h1>
