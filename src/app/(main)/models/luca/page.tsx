    ...
    <PagesWrapper>
        ...
        <div className="w-full mx-auto">
          ...
          <div className="w-full mx-auto flex justify-center">
            <video
              className="rounded-full object-cover xl:w-[16rem] xl:h-[16rem] lg:w-[16rem] lg:h-[16rem] md:w-[12rem] md:h-[12rem] sm:w-[10rem] sm:h-[10rem] w-[8rem] h-[8rem] outline-2 outline-offset-2 outline-gray-500 shadow-xl relative xl:bottom-[7rem] lg:bottom-[8rem] md:bottom-[6rem] sm:bottom-[5rem] bottom-[4.3rem]"
              autoPlay
              muted
              loop
            >
          ...
          <div className="xl:w-[80%] lg:w-[90%] md:w-[94%] sm:w-[96%] w-[92%] mx-auto flex flex-col gap-4 justify-center items-center relative xl:-top-[6rem] lg:-top-[6rem] md:-top-[4rem] sm:-top-[3rem] -top-[2.2rem]">
            {/* FullName */}
            <h1 className="text-center text-gray-800 dark:text-white text-4xl font-serif">Luca - Accountant</h1>
            {/* About */}
            <p className="w-full text-gray-700 dark:text-gray-400 text-md text-pretty sm:text-center text-justify">
            Luca handles accounting, so you don’t have to. It automates entries, maintains records, and delivers real-time financial reports and charts—seamlessly and effortlessly for your company.
            </p>
